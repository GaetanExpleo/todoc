...
public class dataDaoTest {
    ...
    public static final long TASK_1_ID = 1;
    public static final String TASK_1_NAME = "Tache 1";
    public static final long TASK_1_TIMESTAMP  = new Date().getTime();
    public static final Task TASK_1 = new Task(TASK_1_ID, TASK_1_NAME, TASK_1_TIMESTAMP);

    public static final long TASK_2_ID = 2;
    public static final String TASK_2_NAME = "Tache 2";
    public static final long TASK_2_TIMESTAMP  = new Date().getTime();
    public static final Task TASK_2 = new Task(TASK_2_ID, TASK_2_NAME, TASK_2_TIMESTAMP);

    public static final long TASK_3_ID = 3;
    public static final String TASK_3_NAME = "Tache 3";
    public static final long TASK_3_TIMESTAMP  = new Date().getTime();
    public static final Task TASK_3 = new Task(TASK_3_ID, TASK_3_NAME, TASK_3_TIMESTAMP);

    public static final long TASK_4_ID = 4;
    public static final String TASK_4_NAME = "Tache 4";
    public static final long TASK_4_TIMESTAMP  = new Date().getTime();
    public static final Task TASK_4 = new Task(TASK_4_ID, TASK_4_NAME, TASK_4_TIMESTAMP);
}
